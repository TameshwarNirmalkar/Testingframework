...
namespace AutoDesk.Framework.Environment
{
    /// <summary>
    ...
    public class EnvironmentReader
    {
        ...
        public static readonly Enums.Browsers Browser;
        ...
        static EnvironmentReader()
        {
            ...
            // FIXME: Remove IHDtitle for EnvironmentReader.
            //IHDtitle = ConfigurationManager.AppSettings["IHDtitle"];
        }
